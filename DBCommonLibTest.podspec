...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DBCommonLibTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/李明辉/DBCommonLibTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '李明辉' => 'liminghui@data-baker.com' }
  s.source           = { :git => 'https://github.com/李明辉/DBCommonLibTest.git', :tag => s.version.to_s }
